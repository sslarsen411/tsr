<x-app-layout>  
    ...
    <h3 class="text-base md:text-lg mb-2">
        We&apos;ve made it <strong><em>quick</em></strong> and <strong>easy</strong> to share feedback about your experience with us&hellip;
    </h3>
    <x-main-content class="border-2">    
        ...
        <p class="!text-xs self-start">
            * Use the email {{session('location.company')}} has on file. If you&apos;re not sure, just use your best email. 
        </p>
